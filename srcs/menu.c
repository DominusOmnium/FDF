...
/*   Updated: 2019/11/07 14:20:40 by dkathlee         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	print_rotation(t_view *v)
{
	...
	mlx_string_put(v->mlx, v->win, 150, 50, COLOR_TEXT_DEF,
										ft_itoa(v->transform.rotation.x));
	mlx_string_put(v->mlx, v->win, 25, 75, COLOR_TEXT_DEF, "Y:");
	mlx_string_put(v->mlx, v->win, 150, 75, COLOR_TEXT_DEF,
										ft_itoa(v->transform.rotation.y));
	mlx_string_put(v->mlx, v->win, 25, 100, COLOR_TEXT_DEF, "Z:");
	mlx_string_put(v->mlx, v->win, 150, 100, COLOR_TEXT_DEF,
										ft_itoa(v->transform.rotation.z));
}
...
void	print_translation(t_view *v)
{
	...
	mlx_string_put(v->mlx, v->win, 150, 200, COLOR_TEXT_DEF,
										ft_itoa(v->transform.translation.x));
	mlx_string_put(v->mlx, v->win, 25, 225, COLOR_TEXT_DEF, "Y:");
	mlx_string_put(v->mlx, v->win, 150, 225, COLOR_TEXT_DEF,
										ft_itoa(v->transform.translation.y));
	mlx_string_put(v->mlx, v->win, 25, 250, COLOR_TEXT_DEF, "Z:");
	mlx_string_put(v->mlx, v->win, 150, 250, COLOR_TEXT_DEF,
										ft_itoa(v->transform.translation.z));
}
...
void	print_scale(t_view *v)
{
	...
	mlx_string_put(v->mlx, v->win, 150, 350, COLOR_TEXT_DEF,
										ft_itoa((int)v->transform.scale.x));
	mlx_string_put(v->mlx, v->win, 25, 375, COLOR_TEXT_DEF, "Y:");
	mlx_string_put(v->mlx, v->win, 150, 375, COLOR_TEXT_DEF,
										ft_itoa((int)v->transform.scale.y));
	mlx_string_put(v->mlx, v->win, 25, 400, COLOR_TEXT_DEF, "Z:");
	mlx_string_put(v->mlx, v->win, 150, 400, COLOR_TEXT_DEF,
										ft_itoa((int)v->transform.scale.z));
}
